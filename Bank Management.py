customerNames = ['Tharun', 'Lokesh', 'Roopas', 'Thaheer', 'Prasad']
customerPins = ['4373', '4321', '8765', '9132', '1234']
...
while True:
    # os.system("cls")
    print("=====================================")
    print(" ----Welcome to THARUN LOKESH Bank----       ")
    print("*")
    ...
    if choiceNumber == "1":
        ...
        while j < 1:
            ...
            if j < 1:
                ...
                break
            # This statement below helps the user to go back to the start of the program (main menu).
        mainMenu = input("Please press enter key to go back to main menu and perform another Operation or exit ...")
    elif choiceNumber == "3":
